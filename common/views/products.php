...
return [ // View "products"
    ...
    'PRODUCTGROUP'=>[
      ...
      '@linked'=>[
        'THE_PRODUCT_GROUP_NAME'=>['#field'=>'NAME','#label'=>'Group name'],
        'THE_PRODUCT_GROUP_TITLE'=>['#field'=>'TITLE','#label'=>'Group title'],
        'LINKED_PARENT_GROUP'=>[
          '#field'=>'PARENT_ID',
          '@linked'=>[
            'THE_PARENT_GROUP_NAME'=>['#field'=>'NAME','#label'=>'Parent group name']
          ]
        ]
      ]
    ],
    ...
    'SECONDGROUP'=>[
      ...
      '@linked'=>[
        'PRODUCT_SECOND_GROUP_NAME'=>['#field'=>'NAME','#label'=>'Second group name']
      ],
    ],
