...
<div id='popupMiniMenu'>
  <table>
    <tr><td class="menuitemPopupMenu"><a href='#makeRequest'>Заявить о проблеме</a></td></tr>
    <tr><td class="menuitemPopupMenu"><a href='#listRequests'>Мои завки</a></td></tr>
  </table>
</div>
  ...
  function commandRouter(cmd){
    ...
    switch(cmd){
      case 'makeRequest':
        dropCommand();
        $("#popupForm").show();
        $("#popupFormContent").load("form_createreq.php");
      break;
      case 'showReqests':
        dropCommand();
