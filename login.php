...
<div id="signInForm" class="container">
	<form class="form-signin" onSubmit="signIn(event)" action="#!/login">
		<h2 class="form-signin-heading">Вход в систему ОРБИТА.Проект</h2>
...
<div id='signUpForm' class="container hidden">
    ...
    <div class="form-group" id="pass1">
		...
		<label for="inputNewOrg" class="sr-only">Краткое название организации</label>
		<input type="text" id="inputNewOrg" class="form-control" placeholder="Краткое название организации" required>
